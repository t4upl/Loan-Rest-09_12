package com.example.springLoan_18112018.constant;
...
public class SettingTypeUtil {
    ...
    public static final String maxAmount = "max amount";
    public static final String minRejectionHour = "min rejection hour";
